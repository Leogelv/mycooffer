...
### 🟢 Исправление проблемы отображения логотипа
- [x] Скопирован файл логотипа в корневую директорию public
- [x] Обновлен путь к логотипу в компоненте HeroBlock
- [x] Добавлен параметр unoptimized для изображения логотипа
- [x] Проведено тестирование на различных устройствах

### 🟢 Исправление проблемы перекрытия контента градиентами
- [x] Изменен z-index псевдоэлементов ::before и ::after в градиентном фоне на -1
- [x] Исправлен z-index в app/shared/styles.css для улучшения отображения элементов
- [x] Исправлен z-index в components/MeshGradientBackground.module.css для согласованности
- [x] Обеспечено корректное наложение карточек и контента поверх фоновых градиентов

### 🟢 Улучшение адаптивности HeroBlock для мобильных устройств
- [x] Оптимизирована высота блока на мобильных устройствах
- [x] Улучшены отступы и выравнивание для маленьких экранов
- [x] Добавлен атрибут sizes для оптимизации загрузки изображений
- [x] Настроен объект-фит для корректного отображения иллюстраций
- [x] Улучшено отображение текста и заголовков на разных размерах экрана
- [x] Оптимизированы размеры изображений для мобильных устройств
