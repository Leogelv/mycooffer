  ...
  const roadmapData = {
    ...
    stages: [
      ...
      },
      {
        ...
        description: "Разработка мобильного приложения для доступа к системе с любого устройства.",
        deliverable: "Удобный доступ со смартфона, диктовка на ходу",
        duration: "2 недели"
      },
      {
    ...
    pricingInfo: {
      price: "53 700 $",
      description: "Полный объём системы, включая визуализацию, агентов, веб и мобильное приложение с современным дизайном и интуитивным интерфейсом.",
      duration: "6-8 недель",
      modules: 9,
      platform: "Web + Mobile"
    }
